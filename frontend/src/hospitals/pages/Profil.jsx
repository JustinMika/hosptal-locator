...
import { setuserData } from '../redux/loginAdminSlice'
...
const Profil = () => {
    ...
    const _user = useSelector(state => state.loginAdminSlice)

    useEffect(() => {
        setName(_user.user.name)
        setEmail(_user.user.email)
        setPhone(_user.user.telephone)
        setuser(_user.user.user)
    }, [
        _user.user.email,
        _user.user.name,
        _user.user.telephone,
        _user.user.id,
        _user.user.user
    ])
    ...
    const handleSubmit = e => {
        ...
        axios
            .put(`${getUrlApi()}/update-user-infos/`, data)
            .then(data => {
                ...
                dispatch(setuserData(data.data.userId_1000pharma))
    ...
    const handleSubmitFiles = e => {
        ...
        if (files) {
            axios
                .post(`${getUrlApi()}/update-user-profil/`, data)
                .then(data => {
                    toast.info(`${data.data.message}🫡`, {
                        position: 'top-right',
                        autoClose: 9000,
    ...
    const handleChangePasswordSubmit = e => {
        ...
        if (pwd == pwd2) {
            axios
                .put(`${getUrlApi()}/update-user-infos-password/`, data)
                .then(data => {
                    toast.info(`${data.data.message}🫡`, {
                        position: 'top-right',
                        autoClose: 9000,
                                ...
                                <div className='mb-3 flex flex-col gap-5 sm:flex-row'>
                                    ...
                                    <div className='w-full sm:w-1/2'>
                                        ...
                                        <input
                                            ...
                                            name='phoneNumber'
                                            id='phoneNumber'
                                            placeholder={_user.user.telephone}
                                            value={Phone ?? '-'}
                                            onChange={e => {
                    ...
                    <div className='rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
                        ...
                        <div className='p-7'>
                            <form action='#' onSubmit={handleSubmitFiles}>
                                <div className='mb-4 flex justify-center items-center gap-5'>
                                    ...
                                    <div>
                                        ...
                                        <span className='flex gap-2.5'>
                                            <button className='text-sm hover:text-primary bg-red-600 hover:bg-red-700 px-2 py-1 rounded-md shadow-md text-white'>
                                                Delete
                                            </button>
                                ...
                                <div
                                    id='FileUpload'
                                    className='relative mb-2 block w-full cursor-pointer appearance-none rounded border-2 border-dashed border-primary bg-gray-50 py-2 px-4 sm:py-7'
                                >
                                    <input
                                        type='file'
                                        accept='image/*'
                                ...
                                <div className='flex justify-end gap-4'>
                                    <button className='my-2 flex justify-center rounded bg-[#cad3d1] py-2 px-6 font-medium text-gray hover:bg-opacity-70'>
                                        Cancel
                                    </button>
                                    <button
                                        className='my-2 flex justify-center rounded bg-[#039875] py-2 px-6 font-medium text-gray hover:bg-opacity-70'
                                        type='submit'
                                    >
                                        Save
                                    </button>
