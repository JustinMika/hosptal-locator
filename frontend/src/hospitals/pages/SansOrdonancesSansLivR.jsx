...
const SansOrdonancesSansLivR = () => {
    axios.defaults.withCredentials = true
    localStorage.setItem('page', 'Sans Ordonances sans Livraison')
    window.document.title = 'Ordonances sans livraison'
                ...
                <div>
                    <div className='flex mb-4'>
                        ...
                        <select
                            name='perpage'
                            id='perpage'
                            className='p-2 border border-gray-300 rounded-r border-l-0'
                        >
                    ...
                    <table className='w-full border-collapse shadow-md'>
                        <thead>
                            <tr className='bg-gray-100'>
                                ...
                                <th className='py-2 px-4 border'>symptomes</th>
                                <th className='py-2 px-4 border'>Age</th>
                                <th className='py-2 px-4 border'>Sexe</th>
                                <th className='py-2 px-4 border'>Poids</th>
                        ...
                        <tbody>
                            {currentUsers.map(ordonances => (
                                ...
                                >
                                    ...
                                    <td className='py-2 px-4 border'>
                                        {ordonances?.name ?? 'unknown'}
                                    </td>
                                    <td className='py-2 px-4 border'>
                                        {ordonances?.phone}
                                    </td>
                                    <td className='py-2 px-4 border'>
                                        {ordonances?.adresse ?? 'unknown'}
                                    </td>
                                    ...
                                    <td className='py-2 px-4 border'>
                                        {ordonances?.sex}
                                        {ordonances?.isPregnant ? (<span className='text-red-500'>(enceinte)</span>) : ''}
                                    </td>
                                    <td className='py-2 px-4 border'>
                                        {ordonances?.weight}
                                    </td>
...
export default SansOrdonancesSansLivR
