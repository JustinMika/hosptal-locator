...
const OrdonancesSansLivraison = () => {
    axios.defaults.withCredentials = true
    localStorage.setItem('page', 'Ordonances sans Livraison')
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(
                    `${getUrlApi()}/avec-ordonance-sans-livraison/`
                )
    ...
    return (
        <ContentAdmin>
            <div className='w-full bg-white shadow-md rounded-sm p-4'>
                <div>
                            ...
                            <tbody>
                                {currentUsers.map(ordonances => (
                                    ...
                                    >
                                        ...
                                        <td className='py-4 px-4 border2'>
                                            <button
...
export default OrdonancesSansLivraison
